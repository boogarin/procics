...
const Card2 = () => {
    ...
    const rotateX = useTransform(yPcnt, [-0.5, 0.5], ["-15deg", "15deg"]);
            ...
            <div className="flex flex-col justify-between p-5 lg:py-8 xl:p-10">
                <div className="flex flex-row">
                    <div className="flex justify-center w-full flex-col">
                        ...
                        <motion.div initial={{opacity: 0, y: 60}} viewport={{once: true}} whileInView={{ opacity: 0.85, y: 0, scale: 1, transition: {delay: 0.5, duration: 0.5}}} whileHover={{opacity: 1}} 
