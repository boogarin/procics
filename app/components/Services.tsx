...
const Service: React.FC<Types> = ({ title, subtitle, Icon }) => {
    return (
      <div className="w-full p-8 rounded-xl border-[1px] border-slate-300 relative overflow-hidden group bg-white/75 backdrop-blur-md shadow-sm">
        ...
        <div className="flex gap-2 items-center">
            ...
            <h3 className="font-medium text-lg text-[#4d4d4d] group-hover:text-white relative z-10 duration- mb-2">
            {title}
            </h3>
        </div>
